...
let DataPreview = class DataPreview extends React.Component {
    ...
    renderInner() {
        ...
        if (previewed && previewed.isLoadingMetadata) {
            ...
            return (_jsx("div", { className: Styles.placeholder, children: _jsxs(Trans, { i18nKey: "preview.selectToPreview", children: [_jsx("p", { children: "Select a dataset to see a preview" }), _jsx("p", { children: "- OR -" }), _jsx("button", { className: Styles.btnBackToMap, onClick: () => this.backToMap(), children: "Go to the map" })] }) }));
        }
    }
    render() {
